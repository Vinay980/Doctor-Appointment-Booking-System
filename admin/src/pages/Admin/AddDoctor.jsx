      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Experience</p>
              <select className='border rounded px-2 py-2' name="" id="">
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Fees</p>
              <input className="border rounded px-3 py-2" type="number" placeholder="Doctor fees" required="" value="" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex-1 flex flex-col gap-1">
              <p>Degree</p>
              <input className="border rounded px-3 py-2" type="text" placeholder="Degree" required="" value="" />
            </div>
            <div className="flex-1 flex flex-col gap-1">
              <p>Address</p>
              <input className="border rounded px-3 py-2" type="text" placeholder="Address 1" required="" value="" />
              <input className="border rounded px-3 py-2" type="text" placeholder="Address 2" required="" value="" />
            </div>
          </div>
        </div>
        <div>
          <p className="mt-4 mb-2">About Doctor</p>
          <textarea className="w-full px-4 pt-2 border rounded" rows={5} placeholder="write about doctor">
          </textarea>
        </div>
